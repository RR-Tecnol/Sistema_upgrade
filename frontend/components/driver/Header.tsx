...
export default function DriverHeader({ onMenuToggle }: Props) {
    ...
    return (
        <header className="admin-topbar">
            <button onClick={onMenuToggle} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 36, height: 36, borderRadius: 9, marginRight: '0.75rem', border: '1px solid rgba(0,0,0,0.1)', background: 'transparent', cursor: 'pointer', flexShrink: 0, transition: 'all 0.18s' }} aria-label="Abrir menu">
