        ...
        <AdminCollapsibleTutorial
            ...
            steps={[
                ...
                },
                {
                    ...
                    body: (
                        <>
                            <div>O hero do dashboard tem 7 atalhos. Use eles para ir direto para a operação:</div>
                            <TutorialList items={[
                                <><strong>↔ Nova movimentação</strong> — abre o modal genérico de movimentação (entrada, saída, transferência, ajuste, perda, devolução).</>,
                                <><strong>↔ Movimentações</strong> — lista cronológica de TODAS as movimentações já registradas, com filtros por item, carreta, ação, tipo, período.</>,
                                <><strong>🛒 Solicitações</strong> — fila de compras (PENDENTE, APROVADA, RECEBIDA, REJEITADA, CANCELADA).</>,
                                <><strong>📦 Estoque completo</strong> — catálogo (lista de itens) com filtros, badges e ações por card.</>,
                                <><strong>↧ Baixa por ação</strong> — registra o CONSUMO durante/depois de uma ação. Fecha o ciclo das reservas.</>,
                                <><strong>🕐 Auditoria</strong> — histórico técnico (quem mudou o quê, antes × depois, IP, navegador).</>,
                                <><strong>⚡ Novo Item</strong> — wizard de cadastro (3 passos) com atalho opcional para abrir a primeira Solicitação de Compra no mesmo fluxo.</>,
                            ]}/>
                        </>
                    ),
                },
                {
                    ...
                    body: (
                        <>
                            <div>Os 7 cards superiores são <strong>interativos</strong>. Clicando em qualquer um deles, abre um painel lateral à direita com:</div>
                            <TutorialList items={[
                            ...
                            <div style={{ marginTop: 6 }}>Os cards são:</div>
                            <TutorialList items={[
                                <><strong>Valor total</strong> = soma de (preço unitário × quantidade central + soma carretas) para todos os itens ativos.</>,
                                <><strong>Saldo central</strong> = quantidade no depósito (não nas carretas).</>,
                                <><strong>Saldo em carretas</strong> = soma física distribuída.</>,
                                <><strong>Estoque crítico</strong> = itens com saldo ≤ 50% da quantidade mínima cadastrada.</>,
                                <><strong>Estoque baixo</strong> = itens entre 50% e 100% do mínimo (alerta amarelo).</>,
                                <><strong>Vencendo em 30 dias</strong> = itens com validade cadastrada próxima.</>,
                                <><strong>Solicitações pendentes</strong> = PRs aguardando aprovação.</>,
                                <><strong>Em trânsito</strong> = PRs aprovadas aguardando recebimento físico ou pagamento.</>,
                                <><strong>Movimentações no mês</strong> = total de eventos desde o dia 1.</>,
                            ]}/>
                        </>
                    ),
                },
                {
                    ...
                    body: (
                        <>
                            <div><strong>Visão por Categoria</strong> agrega itens nos 8 grupos padrão (Consumível, Didático, Limpeza, Equipamento, EPI, Alimentação, Escritório, Outro) + categorias customizadas criadas pelo admin. Clicar em um card filtra o catálogo.</div>
                            <div style={{ marginTop: 6 }}><strong>Visão por Carreta</strong> mostra, para cada carreta da frota, quantos itens distintos ela tem, quantidade total e itens com saldo baixo. Cada card é link para a ficha da carreta (com o detalhe completo de estoque, manutenções e viagens).</div>
                    ...
                    body: (
                        <>
                            <TutorialList items={[
                                ...
                                <><strong>Ações:</strong> cada ação tem aba "Kit de Insumos" (planejamento) e "Baixa de Estoque" (consumo real). Atalho cruzado: card em /baixa-acao leva direto pra aba "Baixa de Estoque" da ação.</>,
                                <><strong>Carretas:</strong> ficha da carreta mostra a seção "Estoque a bordo" com cada item, quantidade e link para a ficha do item.</>,
