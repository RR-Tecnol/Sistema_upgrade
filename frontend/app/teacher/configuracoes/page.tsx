...
export default function TeacherConfiguracoes() {
    ...
    const [cfg, setCfg] = useState({ nome: '', email: '', notifEmail: true, notifFrequencia: true, notifReembolsos: true, logAcesso: true, animacoes: true, fonteGrande: false, emailOtpEnabled: true });
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.35rem' }} className="animate-fade-in">
            <AdminHeaderHero
                title="CONFIGURAÇÕES"
                subtitle="Personalize sua experiência no portal do professor"
                badge="PROFESSOR"
                rightSlot={(
