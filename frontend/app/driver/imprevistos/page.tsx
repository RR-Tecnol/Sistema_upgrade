                    ...
                    <div>
                        ...
                        {fotoPreview && (
                            <div style={{ position: 'relative', display: 'inline-block' }}>
                                {fotoPreview === 'PDF' ? (
                                    <div style={{ width: 100, height: 140, borderRadius: 8, background: '#F3F4F6', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '2px solid rgba(255,214,0,0.35)', color: '#DC2626', fontWeight: 800 }}>PDF</div>
                                ) : (
