    ...
    return (
        <>
            <style>{`
                ...
                /* Mobile: coluna única, branding vira header compacto */
                @media (max-width: 640px) {
                    ...
                    .login-branding-body { display: none; }
                    .login-branding-features { display: none; }
                    .login-branding-logo {
                        display: flex;
                        align-items: center;
                        gap: 0.65rem;
            ...
            <div className="login-wrapper">
                ...
                <div className={`login-card transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>

                    {/* Left / Top — Branding */}
                    <div className="login-branding">
                        <div style={{ position: 'absolute', top: -60, right: -60, width: 200, height: 200, borderRadius: '50%', background: 'rgba(0,0,0,0.06)', pointerEvents: 'none' }} />
                        <div style={{ position: 'absolute', bottom: -40, left: -40, width: 160, height: 160, borderRadius: '50%', background: 'rgba(0,0,0,0.04)', pointerEvents: 'none' }} />

                        {/* Logo — visible always */}
                        <div className="login-branding-logo" style={{ position: 'relative' }}>
                            <img src="/logo-upgrade.png" alt="Upgrade" style={{ height: 44, width: 'auto', objectFit: 'contain' }} />
                            <div>
                                <h1 style={{ fontFamily: 'Orbitron', color: '#000', fontSize: '1.5rem', fontWeight: 900, letterSpacing: '0.12em', lineHeight: 1 }}>UPGRADE</h1>
                                <p style={{ fontSize: '0.58rem', letterSpacing: '0.18em', color: 'rgba(0,0,0,0.55)', textTransform: 'uppercase', marginTop: '0.15rem', fontWeight: 600 }}>Sistema de Gestão</p>
                            </div>
                        </div>

                        {/* Full branding body — hidden on mobile/tablet */}
                        <div className="login-branding-body" style={{ position: 'relative', marginTop: '2rem' }}>
                            <h2 style={{ fontFamily: 'Orbitron', fontSize: '1.55rem', fontWeight: 800, color: '#000', lineHeight: 1.25, marginBottom: '1rem' }}>
                    ...
                    <div className="login-form-panel">
                        <div style={{ marginBottom: '2rem' }}>
                            <h2 style={{ fontFamily: 'Orbitron', fontSize: '1.2rem', fontWeight: 800, color: '#111827', marginBottom: '0.4rem' }}>Acesso ao Sistema</h2>
                        ...
                        {isDevAuthBypassUi ? (
                            <div style={{ marginTop: '1.5rem', padding: '0.85rem', background: '#ECFDF5', borderRadius: 8, border: '1px solid #6EE7B7', fontSize: '0.75rem', color: '#065F46', lineHeight: 1.5 }}>
                                <strong>Modo localhost:</strong> login vai direto ao dashboard (sem OTP/2FA).
                            </div>
                        ) : (
